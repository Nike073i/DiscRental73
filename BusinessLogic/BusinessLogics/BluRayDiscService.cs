...
namespace BusinessLogic.BusinessLogics
{
    public class BluRayDiscService : DiscCrudService<BluRayDiscReqDto, BluRayDiscResDto>
    {
        ...
        protected override bool IsCorrectReqDto(BluRayDiscReqDto reqDto)
        {
            ...
            if (!string.IsNullOrEmpty(reqDto.SystemRequirements) && (reqDto.SystemRequirements.Length < SystemRequirementsMinLength || reqDto.SystemRequirements.Length > SystemRequirementsMaxLength)) return false;
