...
{
    public abstract class DiscRepository<Req, Res, T> : DbRepository<Req, Res, T>, IDiscRepository<Req, Res> where Req : DiscReqDto, new() where Res : DiscResDto, new() where T : Disc, new()
    {
